...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEST_KEY ="callbacks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            if( savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEST_KEY))
            {
                String allPreviousLifecycleCallbacks = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEST_KEY);
    ...
    protected void onSaveInstanceState( Bundle outState)
    {
        ...
        String lifecyleDisplayTextViewContents = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEST_KEY, lifecyleDisplayTextViewContents);
    }
