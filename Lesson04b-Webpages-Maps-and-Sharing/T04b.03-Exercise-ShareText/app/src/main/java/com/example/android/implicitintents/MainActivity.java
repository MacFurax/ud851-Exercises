...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String text = "This is so important !";
    ...
    private void shareText( String toShare) {
        ...
        ShareCompat.IntentBuilder intentBuidler = ShareCompat.IntentBuilder.from(this)
                .setChooserTitle( title )
                .setType(mimeType)
                .setText(toShare);

        Intent intent = intentBuidler.getIntent();
        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivity(intent);
        }
    }
